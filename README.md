...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 70 agents, 264 skills, and 84 legacy command shims.
...
**That's it!** You now have access to 70 agents, 264 skills, and 84 legacy command shims.
...
|
|-- agents/           # 70 specialized subagents for delegation
...
|---------|---------------------|----------|--------|
| Agents | PASS: 70 agents     | PASS: 12 agents | **Claude Code leads** |
...
|---------|-----------------------|------------|-----------|----------|----------------|
| **Agents** | 70                    | Shared (AGENTS.md) | Shared (AGENTS.md) | 12 | N/A |
